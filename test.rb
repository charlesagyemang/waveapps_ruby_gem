...
#MUTATIONS
# puts ACTIVEWAVE.create_customer("Obudooo", "Kwame", "Eugone")
# puts ACTIVEWAVE.create_invoice(CUSTOMERS[0][:id], PRODUCTS[0][:id])
...
# puts ACTIVEWAVE.list_all_invoices


# puts ACTIVEWAVE.list_all_assets
# puts ACTIVEWAVE.list_all_incomes
# puts ACTIVEWAVE.list_all_expenses
